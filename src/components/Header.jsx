    ...
    <header className="bg-white">
      ...
      >
        <div className="flex lg:flex-1">
          <a href="#" className="-m-7 ml-1.5">
            <span className="sr-only">Suppy</span>
            <img
              className="h-24 w-auto"
              src="./src/assets/SUPPY_LOGO_RED_NOBCK.png"
              alt="Suppy Logo"
            />
          </a>
        </div>
        ...
        <Popover.Group className="hidden lg:flex lg:gap-x-12">
          <Popover className="relative">
            <Popover.Button className="flex items-center gap-x-1 text-sm font-semibold leading-6 text-black hover:text-customRed">
              Product
              <ChevronDownIcon
                className="h-5 w-5 flex-none text-black hover:text-customRed"
                aria-hidden="true"
              />
            </Popover.Button>
                  ...
                  {products.map((item) => (
                    ...
                    >
                      <div className="flex h-11 w-11 flex-none items-center justify-center rounded-lg bg-white group-hover:bg-white">
                        <item.icon
                          className="h-6 w-6 text-customRed group-hover:text-customRed"
                          aria-hidden="true"
                        />
                      </div>
          ...
          <a
            href="#"
            className="text-sm font-semibold leading-6 text-black hover:text-customRed"
          >
            Features
          </a>
          <a
